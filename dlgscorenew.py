...
class Ui_Dialog(object):
    ...
    def calculate(self):
        ...
        self.lw1.clear()
        sql1="select Player_Name from Selected_Teams where Team_Name='"+team+"'"
    ...
    def retranslateUi(self, Dialog):
        ...
        self.cb1.setItemText(0, _translate("Dialog", "Ind_vs_nz_1st_t20"))
        self.cb1.setItemText(1, _translate("Dialog", "Ind_vs_nz_2nd_t20"))
